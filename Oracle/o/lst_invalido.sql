rem 
rem  nome        : lst_invalid.sql
rem  objetivo    : Objetos invalidos
...
--
define p_sql       = lst_invalid
define p_titulo    = 'Objetos invalidos'
...
col object_type            heading "Tipo"
col last        format a17 heading "Ult.Alteracao"
col created     format a17 heading "Criacao"
...
rem
  select owner
        ,object_name
        ,object_type
        ,to_char(created,'dd-mm-yy hh:mi:ss')       created
        ,to_char(last_ddl_time,'dd-mm-yy hh:mi:ss') last
    from dba_objects
