create or replace procedure seu.p_zera_seq_processo
is
...
cursor c1 is select sequence_name,last_number -1 atual from user_sequences where sequence_name like 'SEQ_SEUADL_PROCESSO%';
