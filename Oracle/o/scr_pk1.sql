...
select a.table_name||a.constraint_name||'q0' c0, 0 c1,
 ...
 where a.owner              like upper ('&&OWNER')
   and a.table_name         in ('CUSTOMERS',
'CUSTOMER_CLSSF_INOR_VALUES',
'CUSTOMER_INOR_CCIV_XREFS',
'CUSTOMER_STORES',
'CUSTOMER_STR_INOR_CCIV_XREFS',
'CUSTOMER_STR_SLS_AREA_XREFS',
'DEMAND_GROUP_CONFG_RULES',
'DISTRIBUTION_CENTRES',
'FRCST_CNTRL_ITEM_CUST_XREFS',
'FRCST_CNTRL_ITEM_STR_XREFS',
